...
- Runtime cache: `sw.js` `CACHE_VERSION = "card-battle-r52-v1"`。
- Shell / battle / pack HTML 與 script query 都使用 `card-battle-r52-v1`。
- SW auto reload key 同步為 `card_sw_auto_reload_r52_v1`。
- `package.json` / `package-lock.json` 版本同步到 `0.4.4`。
