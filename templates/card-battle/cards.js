 ...
 *  - 每張卡都有 image 欄位；R66 起卡池已全數接上正式卡圖，載入失敗才走 emoji 防護。
...
const FACTIONS = Object.freeze({
  ...
  neutral: Object.freeze({
    ...
    legend: "不屬四旗，只屬下一次談判的桌面。潮間人往來於堡壘與陵城之間，替白潮送鹽、替結社抄錄殘響、替荒野捎信、也替凜冬點燈——四旗都罵他們牆頭草，開戰前夜卻都排隊敲他們的門。碎潮匯流的每一張契約，末尾都印著同一句話：潮水不選邊，只選還站著的人。",
  }),
});
...
const CARD_POOL = [
  ...
  // 普通
  { id: "mooncat",       name: "月光貓",   type: CARD_TYPE.MINION, rarity: "common", cost: 1, attack: 1, health: 2, emoji: "🐈", image: "../../assets/cards/mooncat.png", keywords: ["lifesteal"], text: "吸血：小巧但能拖住血線。", foil: false },
  ...
  { id: "groveHerbalist", name: "林地藥師", type: CARD_TYPE.MINION, rarity: "common", cost: 3, attack: 2, health: 3, emoji: "🌿", image: "../../assets/cards/groveHerbalist.png", keywords: ["battlecry"], trigger: "healHero2", text: "戰吼：為英雄恢復 2 點。", foil: false },
  { id: "holyGlimmer",   name: "聖光閃耀", type: CARD_TYPE.SPELL,  rarity: "common", cost: 2, emoji: "🌤️", image: "../../assets/cards/holyGlimmer.png", text: "為你的英雄恢復 5 點生命。", effect: "heal5", foil: false },

  // 稀有
  { id: "duskwrightBat", name: "暮影蝠",   type: CARD_TYPE.MINION, rarity: "rare", cost: 2, attack: 2, health: 2, emoji: "🦇", image: "../../assets/cards/duskwrightBat.png", keywords: ["lifesteal"], text: "吸血：穩定回補生命。", foil: false },
  { id: "linebreaker",   name: "破陣槍兵", type: CARD_TYPE.MINION, rarity: "rare", cost: 3, attack: 3, health: 2, emoji: "🪓", image: "../../assets/cards/linebreaker.png", keywords: ["rush"], text: "突襲：清掉前排威脅。", foil: false },
  ...
  { id: "thunderClap",   name: "雷霆震擊", type: CARD_TYPE.SPELL,  rarity: "rare", cost: 3, emoji: "🌩️", image: "../../assets/cards/thunderClap.png", text: "對所有敵方隨從造成 1 點傷害。", effect: "aoe1", foil: false },
  { id: "arcaneVeil",    name: "秘能護幕", type: CARD_TYPE.SPELL,  rarity: "rare", cost: 1, emoji: "🔷", image: "../../assets/cards/arcaneVeil.png", text: "給一個友方隨從一層聖盾。", effect: "giveShield", foil: false },

  // 史詩
  { id: "abyssWalker",   name: "深淵行者", type: CARD_TYPE.MINION, rarity: "epic", cost: 5, attack: 4, health: 6, emoji: "🕳️", image: "../../assets/cards/abyssWalker.png", keywords: ["taunt", "lifesteal"], text: "嘲諷 + 吸血的續戰核心。", foil: false },
  { id: "stormGriffin",  name: "暴風獅鷲", type: CARD_TYPE.MINION, rarity: "epic", cost: 6, attack: 4, health: 4, emoji: "🦅", image: "../../assets/cards/stormGriffin.png", keywords: ["rush", "windfury"], text: "突襲 + 連擊：一回合處理兩個威脅。", foil: false },
  { id: "duskWitch",     name: "暮光女巫", type: CARD_TYPE.MINION, rarity: "epic", cost: 5, attack: 3, health: 5, emoji: "🧹", image: "../../assets/cards/duskWitch.png", keywords: ["battlecry", "lifesteal"], trigger: "damageAny1", text: "戰吼：自動對生命最低的敵方隨從造成 1 點傷害。吸血。", foil: false },
  { id: "starfall",      name: "星界崩落", type: CARD_TYPE.SPELL,  rarity: "epic", cost: 5, emoji: "☄️", image: "../../assets/cards/starfall.png", text: "對所有敵方隨從造成 2 點傷害。", effect: "aoe2", foil: false },
  { id: "forbiddenHex",  name: "禁咒變形", type: CARD_TYPE.SPELL,  rarity: "epic", cost: 5, emoji: "🐸", image: "../../assets/cards/forbiddenHex.png", text: "把一個敵方隨從變成 1/1 綿羊。", effect: "polymorph", foil: false },
  ...
  { id: "battleDrummer",  name: "戰鼓手", type: CARD_TYPE.MINION, rarity: "rare", cost: 2, attack: 1, health: 3, emoji: "🥁", image: "../../assets/cards/battleDrummer.png", keywords: ["battlecry"], trigger: "damageAny1", text: "戰吼：自動對生命最低的敵方手下造成 1 點傷害。", foil: false },
  { id: "sanctuaryWarden", name: "聖所看守", type: CARD_TYPE.MINION, rarity: "rare", cost: 4, attack: 2, health: 6, emoji: "⛪", image: "../../assets/cards/sanctuaryWarden.png", keywords: ["taunt", "battlecry"], trigger: "healHero2", text: "嘲諷。戰吼：為你的英雄恢復 2 點生命。", foil: false },
  { id: "tidebinderHex",  name: "縛潮咒印", type: CARD_TYPE.SPELL,  rarity: "epic", cost: 4, emoji: "🌊", image: "../../assets/cards/tidebinderHex.png", text: "將一個敵方手下變成 1/1 綿羊。", effect: "polymorph", foil: false },
  { id: "bastionColossus", name: "棱堡巨像", type: CARD_TYPE.MINION, rarity: "epic", cost: 6, attack: 4, health: 8, emoji: "🗿", image: "../../assets/cards/bastionColossus.png", keywords: ["taunt", "regenerate"], text: "嘲諷 + 再生：控制牌組的防線核心。", foil: false },
  ...
  { id: "thunderRoc",      name: "雷翼巨鵬", type: CARD_TYPE.MINION, rarity: "rare", cost: 4, attack: 2, health: 4, emoji: "🦅", image: "../../assets/cards/thunderRoc.png", keywords: ["windfury"], text: "連擊：雷聲落下兩次。", foil: false },
  { id: "soulfrostRaven",  name: "魂霜渡鴉", type: CARD_TYPE.MINION, rarity: "rare", cost: 3, attack: 2, health: 3, emoji: "🐦", image: "../../assets/cards/soulfrostRaven.png", keywords: ["lifesteal"], text: "吸血：啄食寒意，回補生命。", foil: false },
  { id: "runicScrivener",  name: "符文抄寫員", type: CARD_TYPE.MINION, rarity: "common", cost: 2, attack: 1, health: 2, emoji: "✒️", image: "../../assets/cards/runicScrivener.png", keywords: ["battlecry"], trigger: "drawCard1", text: "戰吼：抽 1 張牌。", foil: false },
  ...
  { id: "watchtowerBowman", name: "望塔弓手", type: CARD_TYPE.MINION, rarity: "common", cost: 2, attack: 2, health: 3, emoji: "🏹", image: "../../assets/cards/watchtowerBowman.png", keywords: [], text: "守線射手：穩定壓低敵方攻勢。", foil: false },
  ...
  { id: "tacticalRequisition", name: "戰術徵調", type: CARD_TYPE.SPELL, rarity: "epic", cost: 3, emoji: "📦", image: "../../assets/cards/tacticalRequisition.png", text: "抽 2 張牌。", effect: "draw2", foil: false },
  ...
  { id: "toxinViper", name: "毒涎蝰", type: CARD_TYPE.MINION, rarity: "rare", cost: 3, attack: 1, health: 3, emoji: "🐍", image: "../../assets/cards/toxinViper.png", keywords: ["poison", "rush"], text: "劇毒、突襲。低攻擊的精準交換工具。", foil: false },
  { id: "graveScribe", name: "墓碑抄寫員", type: CARD_TYPE.MINION, rarity: "rare", cost: 3, attack: 1, health: 4, emoji: "✒️", image: "../../assets/cards/graveScribe.png", keywords: ["deathrattle"], trigger: "drawCard1", text: "亡語：抽 1 張牌。", foil: false },
  ...
  { id: "silenceOne", name: "封口咒", type: CARD_TYPE.SPELL, rarity: "epic", cost: 2, emoji: "🤫", image: "../../assets/cards/silenceOne.png", keywords: ["silence"], text: "使一個敵方隨從靜默，移除關鍵字、聖盾與亡語。保留攻擊與生命。", effect: "polymorph", silenceOnly: true, foil: false },
  { id: "scoutInterrogator", name: "斥候訊問", type: CARD_TYPE.MINION, rarity: "rare", cost: 3, attack: 2, health: 3, emoji: "🕵️", image: "../../assets/cards/scoutInterrogator.png", keywords: ["battlecry"], trigger: "silenceIfDamaged", text: "戰吼：使一個已受傷的敵方隨從靜默。", foil: false },

  // ===== R61 對座六影：具名角色傳說立繪 =====
  { id: "heroSerHalden", name: "哈爾登隊長", type: CARD_TYPE.MINION, rarity: "legendary", cost: 6, attack: 4, health: 8, emoji: "🛡️", image: "../../assets/cards/heroSerHalden.png", keywords: ["taunt", "shieldwall"], text: "嘲諷。列盾：相鄰友方隨從受到傷害時，本體改承受其中 1 點。", foil: false, set: "hero_shadows_v1", heroTag: true, opponentId: "op_ser_halden", maxCopies: 1 },
  { id: "heroMagisterVey", name: "維伊魔導師", type: CARD_TYPE.MINION, rarity: "legendary", cost: 5, attack: 2, health: 5, emoji: "🔮", image: "../../assets/cards/heroMagisterVey.png", keywords: ["spellpower", "resonance"], text: "法強。殘響：傷害法術結算後，對生命最低的敵方隨從造成固定 1 點傷害。", foil: false, set: "hero_shadows_v1", heroTag: true, opponentId: "op_magister_vey", maxCopies: 1 },
  { id: "heroScarra", name: "斯卡拉狼首", type: CARD_TYPE.MINION, rarity: "legendary", cost: 4, attack: 3, health: 3, emoji: "🐺", image: "../../assets/cards/heroScarra.png", keywords: ["charge", "bloodtrail"], text: "衝鋒。血跡：本體每回合首次傷害敵方英雄後，其他友方隨從本回合攻擊 +1。", foil: false, set: "hero_shadows_v1", heroTag: true, opponentId: "op_scarra", maxCopies: 1 },
  { id: "heroIsoldLongdusk", name: "伊索德·長暮", type: CARD_TYPE.MINION, rarity: "legendary", cost: 6, attack: 5, health: 7, emoji: "🌙", image: "../../assets/cards/heroIsoldLongdusk.png", keywords: ["lifesteal", "chillbind"], text: "吸血。寒噤：本體攻擊敵方隨從並造成傷害後，使其下一個控制器回合無法攻擊。", foil: false, set: "hero_shadows_v1", heroTag: true, maxCopies: 1 },
  { id: "heroRuneFrostfang", name: "霜牙百夫長·魯恩", type: CARD_TYPE.MINION, rarity: "legendary", cost: 5, attack: 3, health: 6, emoji: "🧊", image: "../../assets/cards/heroRuneFrostfang.png", keywords: ["taunt", "sunder"], text: "嘲諷。裂甲：本體攻擊敵方隨從時，先移除其聖盾，再造成傷害。", foil: false, set: "hero_shadows_v1", heroTag: true, maxCopies: 1 },
  { id: "heroMoenTidearbiter", name: "潮間仲裁者·茉恩", type: CARD_TYPE.MINION, rarity: "legendary", cost: 4, attack: 2, health: 3, emoji: "⚖️", image: "../../assets/cards/heroMoenTidearbiter.png", keywords: ["battlecry", "attune"], trigger: "attuneFlexible", needsTarget: "friendlyMinion", text: "戰吼—調印：使一個友方隨從 +1/+1；若場上有至少兩個不同非中立陣營，改為 +2/+2。", foil: false, set: "hero_shadows_v1", heroTag: true, maxCopies: 1 },
];
